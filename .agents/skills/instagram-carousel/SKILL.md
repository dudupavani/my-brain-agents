...
5. O slide 1 contém uma única frase de hook: provocativa o bastante para interromper a rolagem, mas precisa e sustentada pela fonte. Além da tensão ou promessa editorial, a frase deve identificar explicitamente o assunto central do post — nomeando o produto, empresa, pessoa, evento ou categoria inequívoca. Um hook genérico que só faça sentido depois de ler a legenda ou passar para o slide 2 é inválido. Em notícias e posts sobre produtos, o nome do objeto central deve aparecer no próprio hook (por exemplo, “O Grok Bot está sendo desenhado como um colega de trabalho”). Ela é o primeiro texto e o elemento tipográfico dominante.
